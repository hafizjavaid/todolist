...
// Get and Set Filteration of Todos and Projects.
...
// Get Projects From Firebase with each project has it's own todos
...
export function useProjectWithStats(projects, todos){
  ...
  useEffect(()=>{
    ...
    const data = projects.map((project)=>{
      ...
      return{
        numberOfTodos: todos.filter(todo => todo.projectName === project.name && !todo.checked).length,
        ...project,
